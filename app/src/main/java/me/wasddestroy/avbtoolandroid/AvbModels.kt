    ...
    val all: List<AvbCommand> = listOf(
        AvbCommand(
            ...
            args = listOf(
                ...
                AvbArg("--salt", R.string.arg_add_hash_footer_salt_label, ArgType.TEXT, hintRes = R.string.arg_add_hash_footer_salt_hint),
        ...
        AvbCommand(
            ...
            args = listOf(
                ...
                AvbArg("--salt", R.string.arg_add_hashtree_footer_salt_label, ArgType.TEXT, hintRes = R.string.arg_add_hashtree_footer_salt_hint),
