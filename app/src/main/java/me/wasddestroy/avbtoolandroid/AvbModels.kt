...
object AvbCommands {
    val all: List<AvbCommand> = listOf(
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_add_hash_footer_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_add_hashtree_footer_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_info_image_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_erase_footer_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_resize_image_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_extract_vbmeta_image_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_print_partition_digests_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_calculate_vbmeta_digest_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_verify_image_image_label, ArgType.IMAGE, required = true),
        ...
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_zero_hashtree_image_label, ArgType.IMAGE, required = true)
            ),
            readOnly = false, producesFile = true
        ),
        AvbCommand(
            ...
            args = listOf(
                AvbArg("--image", R.string.arg_calculate_kernel_cmdline_image_label, ArgType.IMAGE, required = true),
